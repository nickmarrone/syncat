// keepalive.go: the Ping/Pong idle and dead-connection timer (SPEC.md §4).
// Pure timing state with no I/O of its own — the session owning the
// connection records sends/receives and drives [Keepalive.Run].
