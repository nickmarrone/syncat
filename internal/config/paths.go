// paths.go resolves the XDG on-disk layout (SPEC.md §3) and also holds
// writeFileAtomic, the atomic-write helper config.go and keys.go use to
// persist files into it.
