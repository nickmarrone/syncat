...
// cmdToken implements `syncat token`. It derives the tailcat address from
...
// time, and the pre-shared key is persisted alongside it, precisely so
// this stays stable across invocations and agrees with what the running
// daemon advertises.
