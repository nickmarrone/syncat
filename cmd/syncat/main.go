...
var commands = []command{
	...
	{name: "subscribe", usage: "syncat subscribe PEER SHARE LOCALPATH [--mode mirror|receive]", summary: "sync a peer's share locally (PEER/SHARE: name, id, or id prefix)", implemented: true, run: cmdSubscribe},
